...
class TournamentModelTest(TransactionTestCase):
    ...
    def test_006_tournament_create_round_even(self):
        ...
        print("Lista del test:\n")
        for p in players:
            print(p.lichess_username)
        ...
        for i, round in enumerate(rounds):
            ...
            for j, game in enumerate(round.game_set.all()):
                #print("    ", game)
                #print("VALOR WHITE: ", game.white)
                #print("VALOR SOLUTION WHITE: ", participants[solution[i][j][0]-1])
                #print("VALOR BLACK: ", game.black)
                #print("VALOR SOLUTION BLACK: ", participants[solution[i][j][1]-1])
